...
//Отменяем действие по умолчанию в поп ап форме и вызываем функцию обработки
document.querySelector('#form').addEventListener('submit', (event) => {
    event.preventDefault();
    inputValue();
});

//Ограничение ввода числа от -999 до 999
...
//Функция обработки поп ап формы
function inputValue() {
    if (inputNumber === 0) {
...
//Функция преобразования числа в текстовый вид
